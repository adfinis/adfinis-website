...
export default {
  ...
  bootstrap({ strapi }: { strapi: Core.Strapi }) {
    ...
    async function oneOffCopy() {
      await oneOffCopyHerosToEnAu()
      await oneOffCopyIconCardsToEnAu()
      await oneOffCopyCardProductToEnAu()
      await oneOffCopyCategoriesToEnAu()
      await oneOffCopyContentOfferToEnAu()
      await oneOffCopyQuotesToEnAu()
      await oneOffCopySLACardToEnAu()
      await oneOffCopyEventsPageToEnAu()
      await oneOffCopyNewsToEnAu()
      await oneOffCopyPagesToEnAu()
      await oneOffCopyPageStudyToEnAu()
      await oneOffCopyPartnerProductsToEnAu()
      await oneOffCopySolutionsToEnAu()
      await oneOffCopyCaseStudyOverviewToEnAu()
      await oneOffEventsOverviewToEnAu()
      await oneOffFooterToEnAu()
    }
    oneOffCopy().then(() => {
      console.log('done')
    });
